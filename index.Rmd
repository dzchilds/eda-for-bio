...
This is the online course book for the __Introduction to Exploratory Data Analysis with R__ component of ([APS 135](https://www.shef.ac.uk/aps/currentug/level2/aps135)) module. You can view this book in any modern desktop browser, as well as on your phone or tablet device. The site is self-contained---it contains all the material you are expected to learn this year. Bethan Hindle is running the course this year. Please [email her](mailto:bjhindle1@sheffield.ac.uk?Subject=APS%20135%20general%20query) if you spot any problems.

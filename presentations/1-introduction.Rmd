...
- The attendance sheet will be passed around the room. Please don't forget to sign this before you leave.
...
- One set of roughly 20 questions in week 3 of semester 2B
...
<div>
2. __Read through through the the online course book__ over next 1-2 weeks. Take note: nobody is expecting everything to make perfect sense yet (!), but you should try to at least familiarise yourself with the book.
</div>
<div>
3. __Dylan is away next week__. There will be a practise / help session to reinforce some of today's ideas. If you are having trouble with R / RStudio on your own machine this is a good time to get help. Attendance is compulsory.
</div>

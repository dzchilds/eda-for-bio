...
Download the `storms.csv` data from MOLE. Set your working directory, and then use `read.csv` to read the data in. Assign the resulting data frame the name `storms`.
</div>

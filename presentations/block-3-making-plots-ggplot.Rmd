...
<div id="box-text">
Working with the `storms` dataset, construct a box and whiskers plot to summarise wind speed for each type of storm.  Extension: Change the background colour and the size of the text on the graph (you've done this before).
...
__Saving plots__
<div id="box-text">
Use ggsave to save the box and whiskers plot that you just made. Can you work out where R has saved your plot to (i.e. which folder on your computer)? Can you change the dimensions of the saved plot?
</div>
</div>
...
## Using bar plots to compare means {.smaller}

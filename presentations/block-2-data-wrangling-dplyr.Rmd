...
- The `CENTRAL_AMERICA_STORMS.CSV` data file: climate data for Central America (on Blackboard)
...
Download the `CENTRAL_AMERICA_STORMS.CSV` data from Blackboard. Set your working directory, and then use `read_csv` to read the data in. Assign the resulting data frame the name `storms`.
</div>

...
What are 'vectors'? They are ordered collections of simple things like numbers, characters, TRUE/FALSE values, etc. 
...
Think of vectors as collections of simple things (e.g. numbers) that are ordered. We can create vectors from other vectors using the `c` function. The `c` function (__c__)ombines things together to make vectors.
